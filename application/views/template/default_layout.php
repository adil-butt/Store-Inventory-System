	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav nav-flex-icons">
				...
				<?php if(isset($_SESSION['user']) && $_SESSION['user']['role'] == 2) { ?>
					<li class="nav-item dropdown no-arrow">
						<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<img class="rounded-circle" id="userProfileImage" src="<?php echo isset($_SESSION['user']['profilepath']) ? base_url('assets/profileimages/'.$_SESSION['user']['profilepath']) : ''; ?>" width="50" height="45">
						</a>
				...
				<?php } else { ?>
					<li class="nav-item">
						<?php /* <a href="<?php echo base_url('login') ?>" class="nav-link waves-effect">
							<i class="fas fa-sign-in-alt"></i>
							<?php echo $this->lang->line('sign_in'); ?>
						</a>
						*/ ?>
						<a class="nav-link waves-effect login_btn" data-toggle="modal" data-target="#loginModal">
							<i class="fas fa-sign-in-alt"></i>
							<?php echo $this->lang->line('sign_in'); ?>
						</a>
					</li>
...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php echo $this->lang->line('login'); ?></h5>
				<button class="close" type="button" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">×</span>
				</button>
			</div>
			<div class="modal-body">
			<div class='alert alert-danger d-none login_error_msg' role='alert'></div>
				<div>
					<div class="form-group">
						<div class="form-label-group">
							<input type="text" id="inputEmailOrUsername" class="form-control" placeholder="<?php echo $this->lang->line('email'); ?> <?php echo $this->lang->line('address'); ?>/<?php echo $this->lang->line('user_name'); ?>" required="required" autofocus="autofocus">
					...
					<div class="form-group">
						<div class="form-label-group">
							<input type="password" id="inputPassword" class="form-control" placeholder="<?php echo $this->lang->line('password'); ?>" required="required">
					...
					<button id="login_btn" type="button" class="btn btn-primary btn-block"><?php echo $this->lang->line('login'); ?></button>
				</div>
			</div>
			<div class="modal-footer">
				<a class="btn btn-primary"  href="<?php echo base_url('reg'); ?>"><?php echo $this->lang->line('sign_up'); ?></a>
				<a class="btn btn-secondary" href="<?php echo base_url('forgot-password'); ?>"><?php echo $this->lang->line('forgot_password'); ?></a>
			</div>
		</div>
	</div>
</div>
...
<script type="text/javascript">
	...
	$(document).on('click', '#login_btn', function () {
		...
		if (username == '')
		{
			...
			$(".login_error_msg").text("User name is empty");
		}
		else if (pass == '')
		{
			$(".login_error_msg").removeClass("d-none");
			$(".login_error_msg").text("Password is empty");
		}
		else
		{
			$.ajax({
